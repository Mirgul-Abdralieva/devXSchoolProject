...
public class AboutSwitch {
    public static void main(String[] args) {
        ...
        switch (dayOfWeekInNumber) {
            case 1: dayOfWeekInText = "Monday";
            break;
            case 2: dayOfWeekInText = "Tuesday";
                break;
            case 3: dayOfWeekInText = "Wednesday";
                break;
            case 4: dayOfWeekInText = "Thursday";
                break;
            case 5: dayOfWeekInText = "Friday";
                break;
            case 6:
