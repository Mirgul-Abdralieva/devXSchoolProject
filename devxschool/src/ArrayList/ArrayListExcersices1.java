...
public class ArrayListExcersices1 {
    public static void main(String[] args){
        ...
        System.out.println("list1 and list2 merged into list5:  "+ list5.toString());

        ArrayList<Integer> list6 = cloneTheList(list1);
        ArrayList<Integer> list7 = cloneTheListByClone(list1);
        System.out.println("list1 cloned into list6: "+ list6.toString());
        System.out.println("list1 cloned by clone into list7: "+ list7.toString());
